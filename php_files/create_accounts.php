...
if(is_null($data)){
	...
	AdminAdd($data->one->user_id, $data->one->email, $data->one->password, $data->one->last_name, $data->one->first_name, $data->one->current_role, $data->one->user_type, $data->one->manager_name,
